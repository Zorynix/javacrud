...
public class CustomerController {
    ...
    public ResponseEntity<Page<CustomerDTO>> searchCustomersByName(
        ...
        Page<CustomerDTO> customers = customerService.findByNameContaining(
            name,
            pageable
        );
        return ResponseEntity.ok(customers);
    ...
    public ResponseEntity<List<CustomerDTO>> getCustomersByType(
        ...
        List<CustomerDTO> customers = customerService.findByCustomerType(
            customerType
        );
        return ResponseEntity.ok(customers);
    }
    ...
    public ResponseEntity<List<CustomerDTO>> getActiveCustomers(
        ...
        List<CustomerDTO> customers = customerService.findActiveCustomers(
            startDate,
            endDate,
            minOrders
        );
    ...
    public ResponseEntity<List<CustomerDTO>> getHighValueCustomers(
        ...
        List<CustomerDTO> customers = customerService.findHighValueCustomers(
            minAmount,
            since
        );
        return ResponseEntity.ok(customers);
    ...
    public ResponseEntity<List<CustomerDTO>> getCustomersByTotalSpending(
        ...
        List<CustomerDTO> customers =
            customerService.findCustomersByTotalSpending(totalSpent);
        return ResponseEntity.ok(customers);
    }
